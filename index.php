...
<body>
  ...
  <div id="search_parameters" class="col-lg-8 mx-auto">
    <h2>Where to?</h2>
    <form class="form p-2" method="POST" action="search.php">
      <div class="row align-items-end">
        ...
        <div class="form-group col-lg-1 mb-1">
          ...
          <select class="form-select" id="adults" name="adults" aria-label="Default select example">
        ...
        <div class="form-group col-lg-1 mb-1">
          ...
          <select class="form-select" id="children" name="children" aria-label="Default select example">
      ...
      <div class="col-md-4 d-flex align-items-stretch container_2">
        <div class="info-wrap w-100 p-lg-5 p-4">
          ...
          <div class="dbox w-100 d-flex align-items-center">
            ...
            <div class="text pl-3">
              <p><span>Email:</span> <a href="mailto:easestay@easestay.com"><span>easestay@easestay.com</span></a></p>
            </div>
          </div>
          <div class="dbox w-100 d-flex align-items-center">
            <div class="icon d-flex align-items-center justify-content-center">
            ...
            <div class="text pl-3">
              <p><span>Website:</span> <a href="index.php">easestay.com</a></p>
            </div>
          </div>
        </div>
      </div>
