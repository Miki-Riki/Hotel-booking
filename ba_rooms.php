    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-9 col-md-12 px-4">
                ...
                $sql = "SELECT DISTINCT hotel, price, score, room, bed, facilities, image_url FROM bali LIMIT $offset, $recordsPerPage";
                ...
                if ($result->num_rows > 0) {
                    ...
                    // Pagination links
                    $sqlCount = "SELECT COUNT(DISTINCT hotel) AS total FROM bali";
                ...
                // Read JSON file
                $jsonData = file_get_contents('hotels_list_bali.json');
                ...
                foreach ($data as $hotelData) {
                    ...
                    $sql = "INSERT INTO bali (hotel, price, score, room, bed, facilities, image_url) 
