# Hotel booking & user management using PHP, Bootstrap, MySQL
...
<p style="color: #999;">Note: If you are accessing website from a phone sometimes gets buggy so clear browser cache and it should be good.</p>
