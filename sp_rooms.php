    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-9 col-md-12 px-4">
                ...
                $sql = "SELECT DISTINCT hotel, price, score, room, bed, facilities, image_url FROM spain LIMIT $offset, $recordsPerPage";
                ...
                if ($result->num_rows > 0) {
                    ...
                    // Pagination links
                    $sqlCount = "SELECT COUNT(DISTINCT hotel) AS total FROM spain";
                ...
                // Read JSON file
                $jsonData = file_get_contents('hotels_list_spain.json');
                ...
                foreach ($data as $hotelData) {
                    ...
                    $sql = "INSERT INTO spain (hotel, price, score, room, bed, facilities, image_url) 
