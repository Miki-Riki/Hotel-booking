    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-9 col-md-12 px-4">
                ...
                $sql = "SELECT DISTINCT hotel, price, score, room, bed, facilities, image_url FROM caribbean LIMIT $offset, $recordsPerPage";
                ...
                if ($result->num_rows > 0) {
                    ...
                    // Pagination links
                    $sqlCount = "SELECT COUNT(DISTINCT hotel) AS total FROM caribbean";
                ...
                // Read JSON file
                $jsonData = file_get_contents('hotels_list_caribbean.json');
                ...
                foreach ($data as $hotelData) {
                    ...
                    $sql = "INSERT INTO caribbean (hotel, price, score, room, bed, facilities, image_url) 
